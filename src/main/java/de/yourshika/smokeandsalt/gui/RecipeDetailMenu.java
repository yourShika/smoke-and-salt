...
/**
 * Detail view of a single recipe: station, ingredients, an arrow and the result -
 * laid out visually instead of squeezing everything into the lore.
 */
public final class RecipeDetailMenu {
    ...
    public static void open(SmokeAndSalt plugin, Player player, RecipeView view, int backPage) {
        ...
        // Ingredients.
        List<ItemStack> inputs = view.inputs();
        ...
        holder.set(22, Icons.of(Material.ARROW, "<yellow>Back to recipes"),
                (p, e) -> RecipesMenu.open(plugin, p, backPage));
